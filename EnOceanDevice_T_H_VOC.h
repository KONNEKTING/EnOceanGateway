...
#ifdef KDEBUG
      Debug.print(F("ID: %X"), SenValResp->u8SenderId_p[0] );
      Debug.print(F(" %X"), SenValResp->u8SenderId_p[1] );
      Debug.print(F(" %X"), SenValResp->u8SenderId_p[2] );
      Debug.println(F(" %X"), SenValResp->u8SenderId_p[3] );
#endif
...
#ifdef KDEBUG
      DEBUGSERIAL.print("detect: Sensor_");
...
#ifdef KDEBUG
      SerialUSB.println(SenValResp->temp / 5.0, 1);
      SerialUSB.println(SenValResp->hum / 2.0, 1);
      SerialUSB.println(SenValResp->voc / 2.0, 1);
      Debug.println(F("Batterie: %X"), valueBat);
#endif
